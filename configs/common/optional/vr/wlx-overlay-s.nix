...
#  hm.xdg.configFile."wlxoverlay/conf.d/theme.yaml".source = yaml.generate "clock.yaml" {
#    color_accent = "#008cff";
#    color_danger = "#ff3300";
#    color_faded = "#668299";
#  };
  ...
  hm.xdg.configFile."wlxoverlay/theme/gui/watch.xml".text = ''
    <layout>
        <theme>
        ...
        <macro name="button_style"
               padding="8"
               round="8" color="~color_accent_3" color2="~color_accent_1" gradient="vertical"
                        ...
                        <div flex_direction="column" gap="8">
                            <div gap="8">
                                ...
                                <Button macro="button_style" _press="::ShellExec ${lib.getExe' pkgs.pulseaudio "pactl"} set-sink-volume @DEFAULT_SINK@ +5%" tooltip="MEDIA.VOL_UP" tooltip_side="left">
                                    <sprite width="40" height="40" color="~set_color" src="keyboard/up.svg" />
                                </Button>
                            </div>
                            <div gap="8">
                                ...
                                <Button macro="button_style" _press="::ShellExec ${lib.getExe' pkgs.pulseaudio "pactl"} set-sink-volume @DEFAULT_SINK@ -5%" tooltip="MEDIA.VOL_DOWN" tooltip_side="left">
                                    <sprite width="40" height="40" color="~set_color" src="keyboard/down.svg" />
                                </Button>
                            </div>
                            <div gap="8">
                                <Button macro="button_style" _press="::ShellExec ${lib.getExe pkgs.playerctl} previous" tooltip="MEDIA.PREVIOUS" tooltip_side="left">
                                    <sprite width="40" height="40" color="~set_color" src="keyboard/left.svg" />
                                </Button>
                                <Button macro="button_style" _press="::ShellExec ${lib.getExe pkgs.playerctl} play-pause" tooltip="MEDIA.PAUSE_PLAY" tooltip_side="left">
                                    <sprite width="40" height="40" color="~set_color" src="edit/3d_leftright.svg" />
                                </Button>
                                <Button macro="button_style" _press="::ShellExec ${lib.getExe pkgs.playerctl} next" tooltip="MEDIA.NEXT" tooltip_side="left">
                                    <sprite width="40" height="40" color="~set_color" src="keyboard/right.svg" />
                                </Button>
                            </div>
                        </div>
                    </rectangle>
